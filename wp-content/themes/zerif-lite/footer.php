		...
		<?php
			...
			!empty($zerif_copyright) || !empty($zerif_socials_instagram) ):
						...
						if( !empty($zerif_copyright) ):
							echo '<p id="zerif-copyright">'.pll__(wp_kses_post($zerif_copyright)).'</p>';
						elseif( is_customize_preview() ):
							echo '<p id="zerif-copyright" class="zerif_hidden_if_not_customizer"></p>';
						endif;

						echo '<div class="zerif-copyright-box">'.__('website developed by').'<a href="http://hackanoi.com/"><img alt="" src="http://www.techfest.vn/wp-content/themes/zerif-lite/images/logo-Hackanoi.png"></a></div>';
