					...
					<div class="section-header">
						...
						<?php
							...
							if ( !empty($zerif_contactus_title) ):
								echo '<h2 class="white-text">'.pll__(wp_kses_post( $zerif_contactus_title )).'</h2>';
							...
							if(isset($zerif_contactus_subtitle) && $zerif_contactus_subtitle != ""):
								echo '<div class="white-text section-legend">'.pll__(wp_kses_post( $zerif_contactus_subtitle )).'</div>';
							elseif ( is_customize_preview() ):
