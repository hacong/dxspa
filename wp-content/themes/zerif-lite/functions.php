...
class zerif_ourfocus extends WP_Widget {
    ...
    function widget($args, $instance) {
        ...
        <div class="col-lg-3 col-sm-3 col-xs-6 focus-box" data-scrollreveal="enter left after 0.15s over 1s">
            ...
            <h3 class="red-border-bottom"><?php if( !empty($instance['title']) ): echo apply_filters('widget_title', pll__($instance['title'])); endif; ?></h3>
            <!-- FOCUS HEADING -->
