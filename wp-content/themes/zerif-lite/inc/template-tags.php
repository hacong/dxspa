...
function zerif_our_focus_header_title_function() {
	...
	if( !empty($zerif_ourfocus_title) ):
		echo '<h2 class="dark-text">'.pll__(wp_kses_post( $zerif_ourfocus_title )).'</h2>';
...
function zerif_our_focus_header_subtitle_function() {
	...
	if( !empty($zerif_ourfocus_subtitle) ):
		echo '<div class="section-legend">'.pll__(wp_kses_post( $zerif_ourfocus_subtitle )).'</div>';
	elseif ( is_customize_preview() ):
...
function zerif_latest_news_header_title_function() {
	...
	if( !empty($zerif_latestnews_title) ):
		...
		echo '<h2 class="dark-text">' . pll__(wp_kses_post( $zerif_latestnews_title )) . '</h2>';
...
function zerif_latest_news_header_subtitle_function() {
	...
	if( !empty($zerif_latestnews_subtitle) ):
		...
		echo '<div class="dark-text section-legend">'.pll__(wp_kses_post( $zerif_latestnews_subtitle )).'</div>';
...
function zerif_big_title_text_function() {
	...
	$zerif_bigtitle_title = get_theme_mod('zerif_bigtitle_title',pll__('ONE OF THE TOP 10 MOST POPULAR THEMES ON WORDPRESS.ORG','zerif-lite'));

	if( !empty($zerif_bigtitle_title) ):

		echo '<h1 class="intro-text">'.pll__(wp_kses_post( $zerif_bigtitle_title )).'</h1>';
