...
<section class="about-us" id="aboutus">
	...
	<div class="container">
		...
		<?php
			...
			$zerif_aboutus_feature5_title 	= get_theme_mod('zerif_aboutus_feature5_title',__('YOUR SKILL #5','zerif-lite'));
			...
			switch (
				...
				+
					...
					( empty($zerif_aboutus_feature5_title) && empty($zerif_aboutus_feature5_text) ?
					0 && $text_and_skills=''
				...
				if( !empty($zerif_aboutus_biglefttitle) ):
					...
					echo '<div class="col-lg-' . $colCount . ' col-md-' . $colCount . ' column zerif-rtl-big-title">';
						...
						echo '<div class="big-intro" data-scrollreveal="enter left after 0s over 1s">';
							...
							echo pll__(wp_kses_post( $zerif_aboutus_biglefttitle ));
			...
			(
				...
				!empty($zerif_aboutus_feature5_title) || !empty($zerif_aboutus_feature5_text) ? $there_is_skills='yes' :
				$there_is_skills='');
